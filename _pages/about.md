...
After that I worked for a year at EPAM Systems as an Unreal Engine Developer where I received professional training with the engine and adquired plentiful and valuable experience about game development. While at EPAM, I took part as a technical and design co-lead in a project using Epic's Unreal Editor for Fortnite to create educational gameplay experiences.

Most recently I worked at Plexus Tech as an Unreal Engine Specialist on a digital twin built in Unreal Engine 5 that allowed for the visualization and energy efficiency analysis of a hotel. I was in charge of the full design and development of the UE5 section of the project.

Feel free to check out my <a href="{{ '/portfolio/' | relative_url }}" target="_blank">projects/portfolio</a> page for more.

Outside of graphics, gamedev and engineering I like film, tv, and games (I am a big Destiny/bungie fan, a shame they stopped making the game...). On my spare time I ocassionally play piano as a hobby, mainly enjoying playing covers from tv series or other music I like. Sportswise I love skiing specially off-piste and have been going with my family since I was 3 years old.
